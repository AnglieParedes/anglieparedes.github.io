...
const jobs = [
  ...
  { date: 'Mar 2025 — Presente', company: 'GDS Growth Digital Strategy', grouped: true, current: true, roles: [ { role: 'Diseño Web', date: 'Jun 2025 — Presente', desc: 'Diseño y desarrollo de sitios web en WordPress y Shopify, con implementación en HTML y CSS.', current: true }, { role: 'Diseñadora Gráfica Junior', date: 'Mar 2025 — May 2025', desc: 'Diseño gráfico digital · Piezas de comunicación · Identidad corporativa · Branding · Contenido para web y redes sociales.', badge: '3 meses' } ] },
          ...
          <FadeUp key={i} delay={i * 0.07}>
            {j.grouped ? (
              <div className={styles.row}>
                ...
                <span className={`${styles.badge} ${styles.live} ${styles.badgeHidden}`}>Actual</span>
              </div>
            ) : (
              <div className={styles.row}>
                <div className={styles.date}>{j.date}</div>
